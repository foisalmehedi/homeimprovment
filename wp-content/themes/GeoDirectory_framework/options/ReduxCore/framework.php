...
//                            }
            ...
            public function _validate_options( $plugin_options ) {
                ...
                if ( $plugin_options == $this->options ) {
                    //return $plugin_options; // this is causing problems on some multisites, the values are always the same, so we let is save even if they are the same. (seem to both be old values)
                }
