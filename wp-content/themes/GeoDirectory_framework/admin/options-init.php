...
if (!class_exists('geodirectory_framework_Redux_Framework_config')) {
    ...
    class geodirectory_framework_Redux_Framework_config {
        ...
        public function initSettings() {
            ...
            add_action('redux/options/'.$this->args['opt_name'].'/compiler', array( $this, 'compiler_action' ), 10, 2);
...
$css = implode(" ", $styles).' '.$css;
    ...
    global $reduxConfig;
    add_action('init','gdf_init','0.5');// load on 0.5 or some widget areas wont show.
}
