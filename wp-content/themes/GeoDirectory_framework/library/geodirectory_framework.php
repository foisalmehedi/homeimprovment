...
<li class="welcome"> <span><?php _e('Welcome',GEODIRECTORY_FRAMEWORK);?>, </span>  <a href="<?php echo esc_url( $author_link );?>" title="<?php echo $display_name;?>">  <?php echo $display_name;?></a></li>
